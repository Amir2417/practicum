          ...
          <Navbar.Collapse id="responsive-navbar-nav ">
            <Nav className="ms-auto">
              ...
              {!user ? (
                ...
                <span style={{display:"flex"}} className="flexOffRes">
                  <span style={{display:"flex"}} >
                    <Nav.Link as={Link} to="/myBookings">
                    MyBookings
                  </Nav.Link>
                  {user.email=="amirsohelto@gmail.com"&&<span style={{display:"flex"}}>
                  ...
                  <span style={{marginTop:"10px"}} className="text-primary">{user.displayName}</span>
